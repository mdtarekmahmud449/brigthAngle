...
let dropdown = document.querySelector(`.menu2`);
let dropdown2 = document.querySelector(`.menu3`)
...
bars.addEventListener('click', function(){
    ...
    dropdown2.classList.toggle("show-menu-s");
...
function openCity(evt, cityName) {
    ...
    for (i = 0; i < tablinks.length; i++) {
      ...
      tablinks[i].classList.remove("btn-act")
    }
